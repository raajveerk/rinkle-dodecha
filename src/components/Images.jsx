...
export const Images = () => {
  return (
    ...
    <div className='lg:hidden sm:flex hidden flex-col items-center space-y-[25px] mb-[0px]'>
        {/* <div>
            <img src={quatro} alt="Quatro" className='w-[300px] h-[300px] bg-fixed rounded-lg' />
        </div><br /> */}
        <div>
            <img src={tres} alt="Tres" className='w-[500px] h-[500px] bg-fixed rounded-lg' />
        </div><br />
        {/* <div>
            <img src={sinko} alt="Sinko" className='w-[300px] h-[300px] bg-fixed rounded-lg' />
        </div><br /> */}
        <div>
            <img src={ses} alt="Ses" className='w-[500px] h-[500px] bg-fixed rounded-lg' />
        </div><br />
        <div>
            <img src={uno} alt="Uno" className='w-[500px] h-[500px] bg-fixed rounded-lg'/>
        </div><br />
        {/* <div>
