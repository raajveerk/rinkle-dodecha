...
export const Hero = () => {
  return (
    <div className='mt-[175px] sm:w-full sm:mx-auto mx-[25px] max-w-[800px] text-black sm:mb-[150px] mb-[100px]'>
